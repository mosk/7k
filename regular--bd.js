...
const discountDesc = `10%`;
const discountCode = `БУКЕТДНЯ1`;
...
const newGoods = async () => {
	...
	* img {
	...
	<tr>
        ...
        <tr>
            <td class="text-wrapper" style="padding: 0; padding-bottom: 42px; padding-left: 6%; padding-right: 6%; text-align: left;">
                <span class="text" style="font-family: 'Segoe UI', 'Helvetica Neue', Arial, sans-serif; font-size: 22px; line-height: 1.6; font-weight: 350; color: #464646;">
                    Мы уже обновили <a href="${goods[goods.length - 1].link
					}" style="color: #1B243B; font-weight: 400; text-decoration: underline;">Буĸет&nbsp;дня</a>. На&nbsp;него действует скидка 🔥&nbsp;${discountDesc} по&nbsp;промокоду <b style="display: inline-block; color: #1B243B; font-weight: 600; background-color: #DAF9D3;">${discountCode}</b>, но&nbsp;тольĸо для&nbsp;первых 20 поĸупателей. Переходите на&nbsp;сайт и&nbsp;используйте специальный промоĸод 👇🏻
                </span>
            </td>
        </tr>
        <tr>
            <td style="padding: 0; padding-bottom: 0px; padding-left: 0px; padding-right: 0px;">
            <table cellpadding="0" cellspacing="0" width="100%">
            <tr style="font-size: 0; text-align: center;">
                <td class="col col--1" valign="top" width="300" style="display: inline-block; width: 300px; padding: 0; padding-bottom: 20px;">
                <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                <td style="padding: 0; padding-bottom: 0px; text-align: center;">
                    <a href="${goods[goods.length - 1].link}">
                        <img class="img" src="${goods[goods.length - 1].img
					}" width="280" height="280" style="width: 100%; max-width: 280px; height: auto; max-height: 280px; border-radius: 10px;" alt="Фото букета дня" title="${goods[goods.length - 1].name
					}">
                    </a>
                </td>
                </tr>
                ...
                <td class="col col--2" valign="top" width="300" style="display: inline-block; width: 300px; padding: 0; padding-bottom: 20px;">
                <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                <td class="col__padding" width="10" valign="top" style="padding: 0; font-size: 0; line-height: 0;"></td>
                <td class="col__container" width="280" style="padding: 0;">
                <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td style="padding: 0; padding-top: 20px; padding-bottom: 20px; text-align: left;">
                        <a href="${goods[goods.length - 1].link}">
                            <img class="img" src="https://gallery.retailrocket.net/5c8ba6d697a5253acc2d4f95/5star.png" width="161" height="29" style="width: 100%; max-width: 161px; height: auto; max-height: 29px; border-radius: 10px;" alt="Рейтинг букета: 5 из 5">
                        </a>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 0; padding-bottom: 20px; padding-left: 0px; padding-right: 0px; text-align: left;">
                        <a href="${goods[goods.length - 1].link
                            ...
                            ${goods[goods.length - 1].name}
                        </a>
                    </td>
                </tr> 
                <tr>
                    <td style="padding: 0; padding-bottom: 18px; padding-left: 0px; padding-right: 0px;">
                    <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td style="padding: 0; font-size: 20px; line-height: 1; text-align: left;">
                            <span style="font-family: 'Segoe UI', 'Helvetica Neue', Arial, sans-serif; font-size: 20px; line-height: 34px; color: #464646; font-weight: 350; text-decoration: line-through; vertical-align: middle;">${goods[goods.length - 1].priceRegular
					}</span>
                            &nbsp;
                            <span style="font-family: 'Segoe UI', 'Helvetica Neue', Arial, sans-serif; font-size: 20px; line-height: 34px; color: #464646; font-weight: 350; text-decoration: line-through; vertical-align: middle;">${goods[goods.length - 1].priceNew
					}</span>
                            &nbsp;
                            <b style="font-family: 'Segoe UI', 'Helvetica Neue', Arial, sans-serif; font-size: 20px; line-height: 34px; color: #FF5739; font-weight: 700; text-decoration: none; vertical-align: middle;">${[...getPrice(1).toString()][0]
					} ${[...getPrice(1).toString()][1]}${[...getPrice(1).toString()][2]
					}${[...getPrice(1).toString()][3]}</b>
                            &nbsp;
                            <a href="${goods[goods.length - 1].link
					}" style="display: inline-block; width: auto; min-width: 50px; padding: 0 12px 1px; text-align: center; font-family: 'Segoe UI', 'Helvetica Neue', Arial, sans-serif; font-size: 20px; line-height: 33px; color: #FFFFFF; font-weight: 700; text-decoration: none; vertical-align: middle; background-color: #FF5739; border-radius: 20px;">-${Math.floor(
						getPrice(5)
					)}%</a>
                        </td>
                    </tr>
                ...
                <tr>
                    <td style="padding: 0; padding-bottom: 0px; padding-left: 0px; padding-right: 0px; text-align: left;">
                        <table cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td valign="top" width="75%" style="padding: 0; text-align: left;">
                                    <span style="font-family: 'Segoe UI', 'Helvetica Neue', Arial, sans-serif; font-size: 16px; line-height: 1.6; color: #464646; font-weight: 350;">
                                        Сĸидĸа Семицветиĸ
                                    </span>
                                </td>
                                <td valign="top" width="25%" style="padding: 0; text-align: right;">
                                    <span style="font-family: 'Segoe UI', 'Helvetica Neue', Arial, sans-serif; font-size: 16px; line-height: 1.6; color: #464646; font-weight: 350;">
										${[...getPrice(4).toString()][0]} ${[...getPrice(4).toString()][1]}${[...getPrice(4).toString()][2]
					}${[...getPrice(4).toString()][3]} Р
                                    </span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td valign="top" width="25%" style="padding: 0; text-align: right;">
                                    <b style="font-family: 'Segoe UI', 'Helvetica Neue', Arial, sans-serif; font-size: 16px; line-height: 1.6; color: #FF5739; font-weight: 700;">
										${[...getPrice(2).toString()][0]} ${[...getPrice(2).toString()][1]}${[...getPrice(2).toString()][2]
					}${[...getPrice(2).toString()][3]} Р
                                    </b>
                                </td>
                            </tr>
                        </table>
		...
		<tr>
			<td class="promocode-wrapper" style="padding: 0; padding-bottom: 20px; padding-left: 6%; padding-right: 6%; text-align: center;">
			<div style="width: 298px; margin: 0 auto; padding: 0; border: 1px dashed #9C9C9C; border-radius: 10px; text-align: center;">
			<span class="promocode" style="font-family: 'Segoe UI', 'Helvetica Neue', Arial, sans-serif; font-size: 24px; line-height: 58px; color: #1B243B; font-weight: 600; text-transform: uppercase;">
				${discountCode}
			</span>
			</div>
			</td>
        ...
        <tr>
            <td class="button-wrapper" style="padding: 0; padding-bottom: 70px; padding-left: 6%; padding-right: 6%; text-align: center;">
                <div style="margin: 0 auto; padding: 0; text-align: center;">
                    <!--[if mso]>
                    <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${goods[goods.length - 1].link
					}" style="height: 60px; v-text-anchor: middle; width: 300px;" stroke="f" fillcolor="#07A402">
                    <w:anchorlock/>
                    <center>
                    <![endif]-->
                    <a href="${goods[goods.length - 1].link
					}" style="display: inline-block; width: 300px; text-align: center; color: #FFFFFF; font-family: 'Segoe UI', 'Helvetica Neue', Arial, sans-serif; font-size: 24px; line-height: 60px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.04em; text-decoration: none; background-color: #07A402; background-image: linear-gradient(90deg, #66DA2B 0%, #07A402 100%); background: linear-gradient(90deg, #66DA2B 0%, #07A402 100%); border-top-left-radius: 10px; border-top-right-radius: 10px; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; box-shadow: 0px 0px 30px rgba(255, 255, 255, 0.7); -webkit-text-size-adjust: none;">
                        Успеть заказать
                    </a>
                    <!--[if mso]>
                    </center>
	...
	<tr>
		<td class="block-wrapper" style="padding: 0; padding-top: 0; padding-bottom: 40px;">
			<table class="block block--top" cellpadding="0" cellspacing="0" width="100%" bgcolor="#FFFFFF" style="box-shadow: 0px 0px 10px rgba(206, 209, 213, 0.15);
			border-radius: 10px;">
			<tr>
